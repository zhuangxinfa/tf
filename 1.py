...
#原始图片的存储位置  
orig_picture = 'C:/Users/zhuan/Desktop/tf/pic'#图片在pic文件夹下的 mao和gou 的文件夹下  
#orig_picture = 'C:/Users/zhuan/Desktop/tf/pic'  
  
#生成图片的存储位置  
gen_picture = 'C:/Users/zhuan/Desktop/tf/pic/test_data'  #会在inputdata下生产64x64的数据
  
#需要的识别类型  
classes = {'OK','NOTOK'}   #这是一个dict只不过他的value为零
